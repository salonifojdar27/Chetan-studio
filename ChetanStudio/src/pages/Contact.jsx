...
//   return (
//     <div className="min-h-screen bg-amber-50 flex justify-center items-start pt-28 px-4">
...
//         {/* Form Card */}
//         <div className="bg-white shadow-lg rounded-2xl p-8 md:p-10 mt-10">
    ...
    <div className="min-h-screen bg-amber-50 pt-20 pb-20">
      ...
      >
        <img
          src={img1}
          alt="banner"
          className="w-full h-[280px] md:h-[450px] object-cover rounded-b-2xl shadow-lg"
        />
      </motion.div>
